...
export const GRID = "1fr 132px 92px 60px 108px 118px 70px 78px";
...
/** `PrMeta.findings` key (lowercase) for each `Severity` (uppercase enum). */
export const SEVERITY_TO_FINDINGS_KEY = {
  CRITICAL: "critical",
  WARNING: "warning",
